 ...
 * | This version:   V1.0
 * | Date        :   2019-09-26
 * | Info        :   Basic version (ported to RP2350)
 *
 ******************************************************************************/
...
#define TCR                                                                    \
  0x06 // These registers are accessible only when EFR[4] = 1, and MCR[2] = 1
#define TLR 0x07
...
void SC16IS752_UART_WriteString(UBYTE Channel, const char *buf);
